    ...
    <>
      <div className="flex flex-wrap px-20 pt-20">
        <div className="w-full text-center mb-14">
          <h2 className="text-4xl font-semibold text-white">رُزم تعليم سباحة</h2>
        </div>
          ...
          >
            <li className="-mb-px flex-auto text-center">
              <a
                ...
                role="tablist"
              >
                <div className="text-white p-10 text-center inline-flex items-center justify-center mb-5 shadow-lg rounded-full bg-white">
                  <i className="fas fa-award text-gray-500 text-[120px]"></i>
                </div>
                <div className="text-2xl text-white">الفضية</div>
              </a>
            </li>
            <li className="-mb-px mx-20 flex-auto text-center">
              <a
                className={
                  "text-xs font-bold px-5 py-3 shadow-lg rounded block leading-normal " +
                  (openTab === 2
              ...
              >
                <div className="text-white p-10 text-center inline-flex items-center justify-center mb-5 shadow-lg rounded-full bg-white">
                  <i className="fas fa-award text-yellow-600 text-[120px]"></i>
                </div>
                <div className="text-2xl text-white">الذهبية</div>
              </a>
            </li>
            <li className="-mb-px flex-auto text-center">
              <a
              ...
              >
                <div className="text-white p-10 text-center inline-flex items-center justify-center mb-5 shadow-lg rounded-full bg-white">
                  <i className="fas fa-award text-pink text-[120px]"></i>
                </div>
                <div className="text-2xl text-white">Premium</div>
              </a>
            </li>
          </ul>

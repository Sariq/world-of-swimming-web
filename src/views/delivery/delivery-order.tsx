...
const DeliveryOrderForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-blueGray-700 h-full  bg-white rtl">
      <h1 className="text-2xl font-bold mb-4 text-center">{params.id}</h1>
      <h1 className="text-2xl font-bold mb-4 text-center text-white">طلب توصيل</h1>
